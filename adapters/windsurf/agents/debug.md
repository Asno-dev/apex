---
name: debug
description: "[Dbg] Kai the Debugger — 5-step debug protocol, stack walking, guard injection, bisection."
model:
  mode: subagent
instructions: |
  ...
  - `apex-hands_debug_stack_walk` — Parse stack trace, annotate frames, find root cause frame
  - `apex-hands_debug_log_mine` — Search log files for error/timeout/crash patterns with context
