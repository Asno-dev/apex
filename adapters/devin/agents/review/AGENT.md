...
- **Severity Levels Matter** — Tag: Blocking / Suggestion / Nitpick.

## Tools (apex-hands)
- `diff_cat` — Parse git diff, categorize each change (feature/bugfix/refactor/test/docs)
- `anti_pattern` — Scan code for anti-patterns and code smells
- `quality_gate` — Check code against project quality standards (lint/types/tests/naming)
- `praise_find` — Highlight specific lines demonstrating exceptional quality
- `review_card` — Generate full structured PR review: Summary, Blocking, Suggestions, Praise
